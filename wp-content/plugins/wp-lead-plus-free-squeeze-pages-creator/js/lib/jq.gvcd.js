...
(function ($, window, document, undefined) {
	...
	var p = 'gtcd',
		def = {
			 ...
			 * details.
			 */
			decisecondsWrapper: '.gvcd-dseconds',
	...
	Plugin.prototype = {
		...
		output: function() {
			...
			t.writeDigitsToDom(s.daysWrapper, t.days, 'gvcd-days-digit');
			t.writeDigitsToDom(s.hoursWrapper, t.hours, 'gvcd-hours-digit');
			t.writeDigitsToDom(s.minutesWrapper, t.minutes, 'gvcd-minutes-digit');
			t.writeDigitsToDom(s.secondsWrapper, t.seconds, 'gvcd-seconds-digit');
			t.writeDigitsToDom(s.decisecondsWrapper, t.deciseconds, 'gvcd-dseconds-digit');
			t.writeDigitsToDom(s.millisecondsWrapper, t.milliseconds, 'gvcd-mseconds-digit');
