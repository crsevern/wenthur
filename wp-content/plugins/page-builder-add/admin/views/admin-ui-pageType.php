...
<script type="text/javascript">
    ...
    jQuery('.tab-pagebuilder').on('click', function(e)  {
        var submit_URl = "<?php echo admin_url('admin-ajax.php?action=ulpb_activate_pb_request&page_id='.get_the_id().'&ulpbActivate=ActivatePB').'&POPB_Switch_Nonce='.$plugOps_pageBuilder_switch_nonce; ?>";
    ...
    jQuery('.tab-editor').on('click', function(e)  {
        ...
        var submit_URl = "<?php echo admin_url('admin-ajax.php?action=ulpb_activate_pb_request&page_id='.get_the_id().'ulpbActivate=DeactivatePB').'&POPB_Switch_Nonce='.$plugOps_pageBuilder_switch_nonce; ?>";
        var result = " ";
        $.ajax({
            url: submit_URl,
            method: 'get',
