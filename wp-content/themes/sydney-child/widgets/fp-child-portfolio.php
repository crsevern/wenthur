...
class Sydney_Child_Portfolio extends WP_Widget
{

    public function __construct()
    {
        $widget_ops = array('classname' => 'sydney_portfolio_widget', 'description' => __('Display your projects in a list.', 'sydney'));
        parent::__construct(false, $name = __('Sydney Child FP: Portfolio', 'sydney'), $widget_ops);
        $this->alt_option_name = 'sydney_child_portfolio_widget';
    }
