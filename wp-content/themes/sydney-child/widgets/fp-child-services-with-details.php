...
/**
 * Services With Details widget
 *
 * @package Sydney
 */

class Sydney_Child_Services_With_Details extends WP_Widget
{

	public function __construct()
	{
		$widget_ops = array('classname' => 'sydney_services_widget', 'description' => __('Show what services you are able to provide.', 'sydney'));
		parent::__construct(false, $name = __('Sydney Child FP: Services With Details', 'sydney'), $widget_ops);
		$this->alt_option_name = 'sydney_child_services_with_details_widget';
	}
