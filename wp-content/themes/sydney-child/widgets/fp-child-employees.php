...
class Sydney_Child_Employees extends WP_Widget
{
	...
	public function __construct()
	{
		...
		parent::__construct(false, $name = __('Sydney Child FP: Employees', 'sydney'), $widget_ops);
		$this->alt_option_name = 'sydney_child_employees_widget';
	}
	...
	function widget($args, $instance)
	{
		...
		?>
			...
			<div class="roll-team no-carousel" data-widgetid="employees-<?php echo $args['widget_id']; ?>">
						...
						<div class="team-inner">
								<div class="pop-overlay">
										<div class="team-pop">
												<div class="team-info">
													<div class="name">
													  <a class="linkedin" href="<?php echo esc_url($link); ?>" target="_blank"><?php the_title(); ?></a>
													</div>
													<div class="pos"><?php echo esc_html($position); ?></div>
													<div class="excerpt"><?php echo esc_html($excerpt); ?></div>
													<ul class="team-social">
														<?php if ($link != '') : ?>
															<li><a class="linkedin" href="<?php echo esc_url($link); ?>" target="_blank"><i class="fa fa-linkedin"></i></a></li>
														<?php endif; ?>
													</ul>
												</div>
										</div>
